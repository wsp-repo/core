...
import { MergeArrayModes, mergeJsonObjects } from '../index';
...
describe('Helpers', () => {
  describe('mergeJsonObjects', () => {
    it('Object', getOptions(), () => {
      ...
      expect(mergeJsonObjects(target, source)).toEqual({
    ...
    it('Mutate', getOptions(), () => {
      ...
      const result = mergeJsonObjects(target, source, { mutate: true });
    ...
    it('Array replace', getOptions(), () => {
      ...
      expect(mergeJsonObjects(target, source)).toEqual({ items: [9] });
    });
    ...
    it('Array append', getOptions(), () => {
      ...
      expect(
        mergeJsonObjects(target, source, {
    ...
    it('Unsafe keys', getOptions(), () => {
      ...
      const result = mergeJsonObjects({}, source);
